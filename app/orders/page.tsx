    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 page-enter">
      ...
      {orders.length === 0 ? (
        <div className="text-center py-20 card">
          ...
          <h2 className="font-display text-2xl font-bold text-stone-700 dark:text-zinc-300">
            No orders yet
          </h2>
          <p className="text-stone-400 dark:text-zinc-500 mt-2 mb-6">
              ...
              <div className="p-5">
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    <span
                      className={`badge ${statusColors[order.status] || statusColors.pending} text-xs font-semibold px-3 py-1`}
                    >
                ...
                <div className="flex gap-2 mb-4 flex-wrap">
                  {order.items.slice(0, 4).map((item, i) => (
                    <div
                      key={i}
                      className="relative w-14 h-14 rounded-xl overflow-hidden bg-stone-100 dark:bg-zinc-800 flex-shrink-0"
                    >
                      <Image
                        src={item.image}
                        alt={item.name}
